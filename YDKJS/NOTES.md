...
- [x] [§9.2 Classes and Constructors](../docs/guide.md#92-classes-and-constructors) 
  — [ ] [§9.3 class keyword](../docs/guide.md#93-classes-with-the-class-keyword) 
  — [ ] [§9.4 Add Methods](../docs/guide.md#94-adding-methods-to-existing-classes) 
  — [ ] [§9.5 Subclasses](../docs/guide.md#95-subclasses)
